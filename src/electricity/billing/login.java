...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconsss/second.jpg"))); // NOI18N

        b1.setBackground(new java.awt.Color(204, 204, 255));
        b1.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        b1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconsss/login.png"))); // NOI18N
        b1.setText("Login");
        ...
        b2.setFont(new java.awt.Font("Arial Black", 3, 12)); // NOI18N
        ...
        b3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconsss/signup.png"))); // NOI18N
        b3.setText("Signup");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconsss/eye.png"))); // NOI18N
          ...
          try {
            ...
            con1= DriverManager.getConnection("jdbc:mysql://localhost/electricitybilling","hrushi","kp@143" );        
             Statement s=con1.createStatement();
                ResultSet rs=s.executeQuery("select * from login where username='"+a+"' and password='"+b+"'");
           
            
                if(rs.next()){
                    String meter=rs.getString("meterno");
                    ResultSet rs2=s.executeQuery("select * from customerdetails where meterno='"+meter+"'");
                    if(rs2.next()){
                        String qwerty=rs2.getString("Customername");
                    
      
                    project p1=new project(qwerty,meter);
                    p1.show();
                    dispose();
                    }
                }
